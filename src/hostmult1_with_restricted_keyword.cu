...
// Result 
// (base) eeepc@eeepc-Legion-T7-34IMZ5:~/Documents/CUDA$ ./build/hostmult1_with_restricted_keyword 
// A[1024][1024] * B[1024][1024] = C[1024][1024]: time 4223.752 ms, 0.508 GFLOPS, 3.051 GB/s